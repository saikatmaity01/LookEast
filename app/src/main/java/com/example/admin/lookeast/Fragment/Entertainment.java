...
public class Entertainment extends Fragment {
    RecyclerView rc_entertainment;
    ArrayList<News_Category_SetGet> arr = new ArrayList<>();
    LinearLayoutManager mLayoutManager;
    ListView lv_entertainment;
    @Nullable
    @Override
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        /*rc_entertainment=(RecyclerView)getActivity().findViewById(R.id.rc_entertainment);
        mLayoutManager = new LinearLayoutManager(getActivity());
        rc_entertainment.setLayoutManager(mLayoutManager);*/
        lv_entertainment=(ListView)getActivity().findViewById(R.id.lv_entertainment);
        String url = ConstData.News_Category+"category="+2;
        if (Util.isConnected(getContext())) {
            getEntertainmentData(url);
        }
        else
        {
    ...
    public void getEntertainmentData(String url)
    {
                ...
                try {
                    ...
                    if (status.equals("1")) {
                        ...
                        if(arr.size()>0)
                        {
                            ...
                            lv_entertainment.setAdapter(sportsAdapter);
                            /*MyAdapter myAdapter=new MyAdapter(getActivity(),arr);
                            rc_entertainment.setAdapter(myAdapter);*/
                        }
                    }
