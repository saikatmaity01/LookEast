...
public class National extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        return inflater.inflate(R.layout.national, container, false);
    }
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
      ...
      /*  mRcBatchSchedule = (RecyclerView) getActivity().findViewById(R.id.rc_batchschedule);
        ...
        lv_nat=(ListView)getActivity().findViewById(R.id.lv_nat);
        String url = ConstData.News_Category + "category=" +6;
                ...
                try {
                    ...
                    if (status.equals("1")) {
                        ...
                        if (arr.size() > 0) {
                            ...
                            lv_nat.setAdapter(sportsAdapter);
