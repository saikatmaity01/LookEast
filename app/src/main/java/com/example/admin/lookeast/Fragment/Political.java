...
public class Political extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        return inflater.inflate(R.layout.political, container, false);
    }
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
      ...
      /*  mRcBatchSchedule = (RecyclerView) getActivity().findViewById(R.id.rc_batchschedule);
        ...
        lv_pot=(ListView)getActivity().findViewById(R.id.lv_pot);
        String url = ConstData.News_Category + "category=" + 8;
                ...
                try {
                    ...
                    if (status.equals("1")) {
                        ...
                        if (arr.size() > 0) {
                            ...
                            lv_pot.setAdapter(sportsAdapter);
