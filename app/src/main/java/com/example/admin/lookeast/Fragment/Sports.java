...
public class Sports extends Fragment {
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
      ...
      /*  mRcBatchSchedule = (RecyclerView) getActivity().findViewById(R.id.rc_batchschedule);
        ...
        lv_sports=(ListView)getActivity().findViewById(R.id.lv_sports);
        String url = ConstData.News_Category + "category=" + 4;
                ...
                try {
                    ...
                    if (status.equals("1")) {
                        ...
                        if (arr.size() > 0) {
                            ...
                            lv_sports.setAdapter(sportsAdapter);
